System.register(['./p-ef5fa223.system.js', './p-ec3e6805.system.js'], function (e) {
  'use strict';
  var o, i, t, n, r, s, a;
  return {
    setters: [
    ...
    execute: function () {
      var c = function (e) {
        ...
        for (var i = o.childNodes.length - 1; i >= 0; i--) {
          if (o.childNodes[i].nodeName.toLowerCase() !== 'svg') {
      ...
      var v = e(
        ...
        (function () {
          ...
          e.prototype.waitUntilVisible = function (e, o, i) {
            var t = this;
          ...
          e.prototype.loadIcon = function () {
            ...
            if (this.isVisible) {
              ...
              if (o) {
                if (f.has(o)) {
                  this.svgContent = f.get(o);
                } else {
                  u(o, this.sanitize).then(function () {
                    return (e.svgContent = f.get(o));
                  });
                }
              }
            }
            var i = (this.iconName = a(this.name, this.icon, this.mode, this.ios, this.md));
          ...
          e.prototype.render = function () {
            ...
            var r = this.mode || 'md';
            var s =
              this.flipRtl || (n && (n.indexOf('arrow') > -1 || n.indexOf('chevron') > -1) && this.flipRtl !== false);
            return i(
              t,
              {
                role: 'img',
                class: Object.assign(
                  Object.assign(((e = {}), (e[r] = true), e), b(this.color)),
                  ((o = {}),
                  (o['icon-' + this.size] = !!this.size),
                  (o['flip-rtl'] = !!s && this.el.ownerDocument.dir === 'rtl'),
                  o)
                ),
              },
              this.svgContent
      ...
      var b = function (e) {
        var o;
        return e ? ((o = { 'ion-color': true }), (o['ion-color-' + e] = true), o) : null;
      };
      v.style = d;
    },
  };
