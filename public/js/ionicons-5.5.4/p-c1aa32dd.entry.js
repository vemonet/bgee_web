...
const c = o => {
    if (1 === o.nodeType) {
      ...
      for (let i = 0; i < o.attributes.length; i++) {
        ...
        if (s(t) && 0 === t.toLowerCase().indexOf('on')) return !1;
      }
...
let h = class {
  ...
  loadIcon() {
                      ...
                      t &&
                        ...
                        (t = (o => {
                          ...
                          for (let o = i.childNodes.length - 1; o >= 0; o--)
                            'svg' !== i.childNodes[o].nodeName.toLowerCase() && i.removeChild(i.childNodes[o]);
    ...
    const o = (this.iconName = e(this.name, this.icon, this.mode, this.ios, this.md));
    this.ariaLabel || 'true' === this.ariaHidden || (o && (this.ariaLabel = o.replace(/\-/g, ' ')));
  }
  render() {
    const { iconName: o } = this,
      n = this.mode || 'md',
      s = this.flipRtl || (o && (o.indexOf('arrow') > -1 || o.indexOf('chevron') > -1) && !1 !== this.flipRtl);
    return i(
      t,
      {
        role: 'img',
        class: Object.assign(Object.assign({ [n]: !0 }, f(this.color)), {
          [`icon-${this.size}`]: !!this.size,
          'flip-rtl': !!s && 'rtl' === this.el.ownerDocument.dir,
        }),
      },
      i('div', this.svgContent ? { class: 'icon-inner', innerHTML: this.svgContent } : { class: 'icon-inner' })
    );
  }
