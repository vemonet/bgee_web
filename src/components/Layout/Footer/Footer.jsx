      ...
      <nav className="nav-footer" role="presentation">
        <div className="nav-footer-line">
          <div className="nav-footer-col">
            ...
            <ul>
              <li>
                <Link to={PATHS.ANALYSIS.TOP_ANAT} className="nav_a">
                  TopAnat
                </Link>
              </li>
              <li>
                <Link to={PATHS.ANALYSIS.EXPRESSION_COMPARISON} className="nav_a">
          ...
          <div className="nav-footer-col">
            ...
            <ul>
              <li>
                <Link to={PATHS.SEARCH.GENE} className="nav_a">
                  Gene expression
                </Link>
              </li>
              <li>
          ...
          <div className="nav-footer-col">
            ...
            <ul>
              <li>
                <Link to={PATHS.DOWNLOAD.GENE_EXPRESSION_CALLS} className="nav_a">
                  Gene expression calls
                </Link>
              </li>
              <li>
                <Link to={PATHS.DOWNLOAD.PROCESSED_EXPRESSION_VALUES} className="nav_a">
          ...
          <div className="nav-footer-col">
            ...
            <ul>
              <li>
                <Link to={PATHS.RESOURCES.R_PACKAGES} className="nav_a">
                  R packages
                </Link>
              </li>
              <li>
          ...
          <div className="nav-footer-col">
            ...
            <ul>
              <li>
                <Link to={PATHS.SUPPORT.TUTORIALS} className="nav_a">
                  Documentation and tutorials
                </Link>
              </li>
              <li>
                <Link to={PATHS.SUPPORT.FAQ} className="nav_a">
                  FAQ
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to={PATHS.ABOUT.PUBLICATION} className="nav_a">
                  Cite us
                </Link>
              </li>
            </ul>
