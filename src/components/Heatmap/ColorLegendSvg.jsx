...
export const ColorLegendSvg = ({ posX, posY, height, colorScale, width, interactionData }) => {
  ...
  return (
    <g>
      <text x={posX} y={posY - 10} fontSize={10} textAnchor="left" fontWeight="bold">
        Expression score
      </text>
      <g>
        <rect
      ...
      <g>
        <rect
          ...
          rx={4}
        />
        <text x={posX + 15} y={posY + 48} fontSize={10} textAnchor="left">
          Not expressed
        </text>
      </g>
      <g>
        <rect
          ...
          rx={4}
        />
        <text x={posX + 115} y={posY + 48} fontSize={10} textAnchor="left">
          No data
        </text>
      </g>
    </g>
