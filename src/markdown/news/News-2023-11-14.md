...
We have focused on updating _Drosophila melanogaster_ data, with the integration
...
- Droplet-based data are fully integrated in our expression calls and expression scores as any other data type.
  See for instance the [expression calls for the fly gene _eya_](/gene/FBgn0000320) ("Developmental protein eyes absent"),
