...
- Addition of mouse _in situ_ data from MGI, see [mouse data](https://archives.bgee.org/13-2/?page=download&action=expr_calls#id2).
...
- Removal of data incorrectly considered as normal in
  _C. elegans_, see [worm data](https://archives.bgee.org/13-2/?page=download&action=expr_calls#id5).
